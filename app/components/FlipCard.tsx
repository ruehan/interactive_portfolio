...
export default function FlipCard({ card, className = "" }: FlipCardProps) {
	...
	return (
		...
		>
			<motion.div className="w-full h-full relative preserve-3d duration-700 ease-in-out" initial={false} animate={{ rotateY: isFlipped ? 180 : 0 }} transition={{ duration: 0.6, ease: "easeInOut" }}>
				{/* 카드 전면 */}
