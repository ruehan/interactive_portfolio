...
export const meta: MetaFunction = () => {
  return [
    ...
    { property: 'og:title', content: '한규 | 풀스택 개발자 포트폴리오' },
    {
      ...
      content: 'Remix, React, Node.js를 활용한 풀스택 개발자 한규의 포트폴리오 사이트입니다.',
    },
...
export default function Index() {
  ...
  return (
    <main className="min-h-screen text-gray-800 dark:text-gray-200 overflow-x-hidden">
      ...
      <section
        ref={heroRef}
        className="relative min-h-screen flex items-center justify-center pt-16 pb-32 px-4 sm:px-6 lg:px-8"
      >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-left">
              ...
              >
                <p className="text-gray-600 dark:text-gray-400 text-lg mb-8 max-w-lg mx-auto lg:mx-0">
                  Remix, React, TypeScript를 활용한 현대적인 웹 애플리케이션 개발에 열정을 가지고 있습니다. 직관적인
                  UI와 최적화된 사용자 경험을 구현하기 위해 노력합니다.
                </p>
              </motion.div>
              ...
              >
                <a
                  href="#projects"
                  className="px-6 py-3 rounded-lg bg-black/70 text-white font-medium hover:bg-black/90 transition-colors border border-gray-500/30"
                >
                  프로젝트 보기
                </a>
                <a
                  href="#contact"
                  className="px-6 py-3 rounded-lg bg-black/50 backdrop-blur-sm text-white font-medium hover:bg-black/70 transition-colors border border-gray-500/30"
                >
                  연락하기
                </a>
              </motion.div>
            ...
            >
              <div className="relative w-64 h-64 sm:w-80 sm:h-80">
                ...
                <div
                  className="absolute -top-4 -left-4 w-24 h-24 rounded-full bg-blue-500 blur-xl opacity-10 animate-ping"
                  style={{ animationDuration: '6s' }}
                />
                <div
                  className="absolute -bottom-4 -right-4 w-32 h-32 rounded-full bg-purple-500 blur-xl opacity-10 animate-ping"
