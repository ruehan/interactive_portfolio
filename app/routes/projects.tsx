...
export const meta: MetaFunction = () => {
	return [{ title: "프로젝트 갤러리 | 한규 포트폴리오" }, { name: "description", content: "한규의 포트폴리오 프로젝트 갤러리입니다. 웹, 모바일, 데스크톱 등 다양한 프로젝트를 확인해보세요." }];
};

// 로더 함수: 프로젝트 데이터와 필터링 옵션을 제공
...
export function ErrorBoundary() {
	return (
		<div className="container mx-auto px-4 py-16 text-center">
			...
			<p className="text-gray-600 dark:text-gray-400 mb-8">프로젝트 데이터를 불러오는 중에 문제가 발생했습니다. 잠시 후 다시 시도해 주세요.</p>
	...
	return (
		<div className="container mx-auto px-4 py-16">
			...
			<p className="text-gray-600 dark:text-gray-400 text-center mb-12 max-w-2xl mx-auto">
				다양한 기술 스택과 프로젝트 유형별로 필터링하여 프로젝트를 살펴보세요. 각 프로젝트를 클릭하면 상세 정보를 확인할 수 있습니다.
			</p>
							...
							{projectTypes.map((type) => (
								<button
									...
									className={`px-3 py-1.5 rounded-md text-sm transition-all ${
										type === activeTypeFilter ? "bg-blue-600 text-white shadow-md scale-105" : "bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-gray-600"
					...
					<div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md">
						...
						<div className="flex flex-wrap gap-2">
							<button
								...
								className={`px-3 py-1.5 rounded-md text-sm transition-all ${
									!activeTechFilter ? "bg-blue-600 text-white shadow-md scale-105" : "bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-gray-600"
								}`}
							>
								모든 기술
							</button>
							...
							{technologies.map((tech) => (
								<button
									...
									className={`px-3 py-1.5 rounded-md text-sm transition-all ${
										tech === activeTechFilter ? "bg-blue-600 text-white shadow-md scale-105" : "bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-gray-600"
